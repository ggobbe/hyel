//Script modifié ligne 315 pour conformité à V2, Plume
...
namespace Server.Misc
{
    public class Weather
    {
        ...
        public static void Initialize()
        {
            ...
            // village pecher
            AddWeather(+15, 50, 5, new Rectangle2D(472, 2636, 360, 276));
            // balistae
            AddWeather(+15, 50, 5, new Rectangle2D(2030, 2834, 336, 602));
            // cantari maera koko ylianar
            AddWeather(+15, 50, 5, new Rectangle2D(2198, 3670, 876, 394));
            //lagon			
            AddWeather(+15, 50, 5, new Rectangle2D(4376, 3664, 656, 314));
            // ice
            AddWeather(-15, 100, 60, new Rectangle2D(3492, 188, 1484, 732), new Rectangle2D(4112, 948, 380, 260), new Rectangle2D(4500, 952, 456, 480));
