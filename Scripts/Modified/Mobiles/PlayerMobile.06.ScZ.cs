/**
 * Scriptiz@18/11/07 : ajout de champs pour la commande .possess
 **/
using System;
...
namespace Server.Mobiles
{
	...
	public class PlayerMobile : Mobile, IHonorTarget
	{
        ...
        // Eckmuhl : Ajout Hierarchie
        private int m_Foi;
        private int m_Noblesse;
        private int m_Assassinat;
        private int m_Druidisme;
        ...
        public int Noblesse
        {
            get { return m_Noblesse; }
            set { m_Noblesse = value; }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int Druidisme
        {
            get { return m_Druidisme; }
            set { m_Druidisme = value; }
        }
        /**
         * Fin Eckmuhl
         **/
		...
		public override void Resurrect()
		{
			...
			base.Resurrect();
			/* Hyel 2.0 Alpha */
			BodyValue = HyelRaceSystem.AliveBody( HyelRace, Female );
		...
		public override void OnDeath( Container c )
		{
			...
			/* Hyel 2.0 Alpha */
			BodyValue = HyelRaceSystem.DeathBody( HyelRace, Female );
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			switch ( version )
			{
                ...
                case 28:
                    {
                        m_HyelClasse = (HyelClasse)(reader.ReadEncodedInt());
                        goto case 27;
                    }
                /**
                 * Debut Eckmuhl
                ...
                case 27:
                    {
                        m_Foi = reader.ReadEncodedInt();
                        m_Noblesse = reader.ReadEncodedInt();
                        m_Assassinat = reader.ReadEncodedInt();
                        m_Druidisme = reader.ReadEncodedInt();
                        goto case 26;
                    }
                /**
                 * Fin Eckmuhl
		...
		public override void Serialize( GenericWriter writer )
		{
            ...
            // version 28 - Scriptiz : Ajout de HyelClasse + correction HyelRace
            // version 29 - Scriptiz : Ajout de l'Inconscience
            writer.Write((int)29);  

            // version 29
            writer.WriteDeltaTime(m_LastInconscience);

            // version 28 : Scriptiz - Choix de vie
            writer.WriteEncodedInt((int)m_HyelClasse);

            // version 27 : Eckmuhl - Hierarchie
            writer.WriteEncodedInt((int)m_Foi);
            writer.WriteEncodedInt((int)m_Noblesse);
            writer.WriteEncodedInt((int)m_Assassinat);
            writer.WriteEncodedInt((int)m_Druidisme);

			// version 26 : Hyel 2.0 Alpha
