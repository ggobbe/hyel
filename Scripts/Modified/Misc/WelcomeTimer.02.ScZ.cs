...
namespace Server.Misc
{
	...
	public class WelcomeTimer : Timer
	{
		...
		{
            /**
             * Scriptiz : Placé dans le OnLogin du PlayerMobile en cas d'erreur lors de l'inscription
             */
            /*
			if( m_State == 0 && ( m_Mobile.BodyValue == 0x190 || m_Mobile.BodyValue == 0x191 ) ) {
				m_Mobile.SendGump( new HyelCharacterCreationGump( (PlayerMobile)m_Mobile ) );
			}
            */
