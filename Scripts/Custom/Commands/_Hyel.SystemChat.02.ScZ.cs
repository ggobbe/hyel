...
namespace Server.Commands
{
    public class SystemChat
    {
        ...
        public static void dMessage_OnCommand(CommandEventArgs e)
        {
            ...
            {
                from.SendMessage("Vous avez été banni du Channel HRP.");
            }
            else
            {
                if (from.ChanCH == CCCH.Close)
                {
                    from.SendMessage("Votre Channel HRP est Fermé");
                }
                else
                {
                    ...
                    {
                        BroadcastMessage(AccessLevel.Player, 0, String.Format("{0}: {1}", e.Mobile.Name, e.ArgString), 0);
                        // ancienne hue : 253
                    }
        ...
        public static void rpMessage_OnCommand(CommandEventArgs e)
        {
            ...
            {
                from.SendMessage("Vous avez été banni du Channel RP.");
            }
            else
            {
                if (from.ChanCR == CCCR.Close)
                {
                    from.SendMessage("Votre Channel RP est Fermé");
                }
                else
                {
        ...
        public static void dInfoMessage_OnCommand(CommandEventArgs e)
        {
            ...
            {
                from.SendMessage("Vous avez été banni du Channel annonce.");
            }
            else
            {
                if (from.ChanInfo == CCCINFO.Close)
                {
                    from.SendMessage("Votre Channel annonce est Fermé");
                }
                else
                {
        ...
        public static void CMessage_OnCommand(CommandEventArgs e)
        {
            ...
            {
                from.SendMessage("Vous avez été banni du Channel Staff.");
            }
            else
            {
                if (from.ChanStaff == CCC.Close)
                {
                    from.SendMessage("Votre Channel Staff est Fermé");
                }
                else
                {
        ...
        public static void dOpenMessage_OnCommand(CommandEventArgs e)
        {
            Mobile somemobile = e.Mobile;
            PlayerMobile from = somemobile as PlayerMobile;
            // Scriptiz[   (ajout de l'impossibilité d'ouvrir si banni)
            if (from.ChanCH == CCCH.Ban)
            {
                from.SendMessage(1000, "Vous êtes banni du chan HRP !");
            }
            else
            {
        ...
        public static void rpOpenMessage_OnCommand(CommandEventArgs e)
        {
            ...
            if (from.ChanCR == CCCR.Ban)
            {
                from.SendMessage(1000, "Vous êtes banni du chan RP !");
            }
            else
            {
        ...
        public static void dInfoOpenMessage_OnCommand(CommandEventArgs e)
        {
            ...
            if (from.ChanInfo == CCCINFO.Ban)
            {
                from.SendMessage("Vous êtes banni du chan Info !");
            }
            else
            {
        ...
        public static void COpenMessage_OnCommand(CommandEventArgs e)
        {
            ...
            if (from.ChanStaff == CCC.Ban)
            {
                from.SendMessage("Vous êtes banni du chan Staff !");
            }
            else
            {
        ...
        public static void dCloseMessage_OnCommand(CommandEventArgs e)
        {
            ...
            if (from.ChanCH == CCCH.Ban)
            {
                from.SendMessage("Vous êtes banni du chan HRP !");
            }
            else
            {
                from.ChanCH = CCCH.Close;
                from.SendMessage(1000, "Channel HRP Fermé");
            }
            // ]Scriptiz
        }
        [Usage("rpClose")]
        ...
        public static void rpCloseMessage_OnCommand(CommandEventArgs e)
        {
            ...
            if (from.ChanCR == CCCR.Ban)
            {
                from.SendMessage("Vous êtes banni du chan RP !");
            }
            else
            {
                from.ChanCR = CCCR.Close;
                from.SendMessage(1000, "Channel RP Fermé");
            }
            // ]Scriptiz
        }
        [Usage("sInfoClose")]
        ...
        public static void dInfoCloseMessage_OnCommand(CommandEventArgs e)
        {
            ...
            else
            {
                ...
                from.SendMessage(1000, "Channel info Fermé");
            }
            // ]Scriptiz
        }
        ...
        public static void CCloseMessage_OnCommand(CommandEventArgs e)
        {
            ...
            else
            {
                ...
                from.SendMessage(1000, "Channel Staff Fermé");
            }
            // ]Scriptiz
        }
         */
