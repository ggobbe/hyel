...
{
	public class SanctuaireSpell : ClericSpell
	{
		...
		public SanctuaireSpell( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		{
			private SanctuaireSpell m_Owner;

			public InternalTarget( SanctuaireSpell owner ) : base( 12, true, TargetFlags.None )
			{
				m_Owner = owner;
			}
