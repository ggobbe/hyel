...
{
	public class ResurectionSpell : ClericSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
				"Resurection", "Anima Vivanto",
				212,
				9041
			);
		...
		public ResurectionSpell( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		{
			private ResurectionSpell m_Owner;

			public InternalTarget( ResurectionSpell owner ) : base( 12, false, TargetFlags.Beneficial )
			{
				m_Owner = owner;
			}
