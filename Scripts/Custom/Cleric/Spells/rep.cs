...
{
	public class repSpell : ClericSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
				"Bouclier Divin", "Deus Valus",
				236,
				9011
		...
		public repSpell( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		public override void OnCast()
		{
				...
				if ( CheckSequence() )
				{
					...
					if ( mods == null )
					{
						...
						mods = new ResistanceMod[5]
							{
								new ResistanceMod( ResistanceType.Physical, 15 + (int)(targ.Skills[SkillName.SpiritSpeak].Value / 20) ),
			...
			else
			{
				...
				else if ( CheckSequence() )
				{
					...
					{
						int value = (int)(Caster.Skills[SkillName.SpiritSpeak].Value + Caster.Skills[SkillName.Healing].Value + Caster.Skills[SkillName.Anatomy].Value);
						value /= 3;
