...
namespace Server.Spells.DarkPaladin
{
    public class DPSacredJourneySpell : DarkPaladinSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
                "Chemin Maléfique", "Tennebra Viatas",
				-1,
				9002
			);
		...
		public DPSacredJourneySpell( Mobile caster, Item scroll ) : this( caster, scroll, null, null )
		{
		}

        public DPSacredJourneySpell(Mobile caster, Item scroll, RunebookEntry entry, Runebook book)
		...
		{
			private DPSacredJourneySpell m_Owner;

			public InternalTarget( DPSacredJourneySpell owner ) : base( 12, false, TargetFlags.None )
			{
				m_Owner = owner;
			}
