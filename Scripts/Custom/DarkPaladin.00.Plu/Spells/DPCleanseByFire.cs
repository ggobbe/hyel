...
{
	public class DPCleanseByFireSpell : DarkPaladinSpell
	{
        ...
        public DPCleanseByFireSpell(Mobile caster, Item scroll)
		...
		public void Target( Mobile m )
		{
			...
			else if ( CheckBSequence( m ) )
			{
				...
				int damage = 50 - DarkComputePowerValue( 4 );
		...
		{
			private DPCleanseByFireSpell m_Owner;

			public InternalTarget( DPCleanseByFireSpell owner ) : base( 12, false, TargetFlags.Beneficial )
			{
				m_Owner = owner;
			}
