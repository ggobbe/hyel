...
{
	public class DPHolyLightSpell : DarkPaladinSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
                "Lumiere Maudite", "Tennebra Luminos",
				-1,
				9002
			);
		...
		public DPHolyLightSpell( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		public override void OnCast()
		{
			if ( CheckSequence() )
			{
				...
				for ( int i = 0; i < targets.Count; ++i )
				{
					...
					int damage = DarkComputePowerValue( 10 ) + Utility.RandomMinMax( 0, 2 );
