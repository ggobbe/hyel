...
{
	public class DPEnemyOfOneSpell : DarkPaladinSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
                "Choisir sa victime", "Kora Solum",
				-1,
				9002
			);
        ...
        public DPEnemyOfOneSpell(Mobile caster, Item scroll)
		...
		public override void OnCast()
		{
			if ( CheckSequence() )
			{
				...
				double delay = (double)DarkComputePowerValue( 1 ) / 60;
