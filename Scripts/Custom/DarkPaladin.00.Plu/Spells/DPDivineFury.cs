...
{
	public class DPDivineFurySpell : DarkPaladinSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
                "Fureur Sombre", "Tennebra Furis",
				-1,
				9002
			);
        ...
        public DPDivineFurySpell(Mobile caster, Item scroll)
		...
		public override void OnCast()
		{
			if ( CheckSequence() )
			{
				...
				int delay = DarkComputePowerValue( 10 );
