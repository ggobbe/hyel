...
{
	public class DPCloseWoundsSpell : DarkPaladinSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
                "Regeneration du Mal", "Echo Vulnar", -1, 9002
			);
        ...
        public DPCloseWoundsSpell(Mobile caster, Item scroll)
		...
		public void Target( Mobile m )
		{
			...
			else if ( CheckBSequence( m ) )
			{
				...
				int toHeal = DarkComputePowerValue( 6 ) + Utility.RandomMinMax( 0, 2 );
		...
		{
			private DPCloseWoundsSpell m_Owner;

			public InternalTarget( DPCloseWoundsSpell owner ) : base( 12, false, TargetFlags.Beneficial )
			{
				m_Owner = owner;
			}
