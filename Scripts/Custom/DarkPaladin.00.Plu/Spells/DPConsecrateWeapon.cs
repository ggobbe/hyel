...
{
	public class DPConsecrateWeaponSpell : DarkPaladinSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
                "Reflet de sang", "Energia Arma",
				-1,
				9002
			);
        ...
        public DPConsecrateWeaponSpell(Mobile caster, Item scroll)
		...
		public override void OnCast()
		{
			...
			else if ( CheckSequence() )
			{
				...
				double seconds = DarkComputePowerValue( 20 );
