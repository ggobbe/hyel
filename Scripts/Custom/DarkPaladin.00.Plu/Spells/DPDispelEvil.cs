...
{
	public class DPDispelEvilSpell : DarkPaladinSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
                "Repousser  le mal", "Evictus Demonia",
				-1,
				9002
			);
        ...
        public DPDispelEvilSpell(Mobile caster, Item scroll)
		...
		public override void OnCast()
		{
			if ( CheckSequence() )
			{
				...
				int dispelSkill = DarkComputePowerValue( 2 );
