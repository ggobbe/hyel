...
{
	public abstract class DarkPaladinSpell : Spell
	{
        ...
        public DarkPaladinSpell (Mobile caster, Item scroll, SpellInfo info)
		...
		public int DarkComputePowerValue( int div )
		{
			return DarkComputePowerValue( Caster, div );
		}

		public static int DarkComputePowerValue( Mobile from, int div )
		{
			if ( from == null )
				return 0;
