...
{
	public class DarkTithingGump : Gump
	{
		private Mobile m_From;
		private int m_Offer;

        public DarkTithingGump(Mobile from, int offer)       : base(160, 40)
		{
			...
			//AddHtmlLocalized( 95, 100, 120, 100, "<BASEFONT COLOR=RED>Bienvenue à toi serviteur du Mal", false, false ); // May your wealth bring blessings to those in need, if tithed upon this most sacred site.
			AddHtml( 95, 100, 120, 100, "<BASEFONT COLOR=RED>Bienvenue à toi serviteur du Mal, puise dans cette fontaine Maléfique", false, false ); // May your wealth bring blessings to those in need, if tithed upon this most sacred site.

			AddLabel( 57, 274, 0, "Or:" );
			AddLabel( 87, 274, 53, (totalGold - offer).ToString() );

			AddLabel( 137, 274, 0, "S:" );
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			switch ( info.ButtonID )
			{
				case 0:
				{
					...
					m_From.LocalOverheadMessage( MessageType.Regular, 0xb94, true, "Va-t-en Vermine" );
					break;
				}
				case 1:
				case 2:
				...
				case 4:
				{
                    ...
                    m_From.SendGump(new DarkTithingGump(m_From, offer));
					break;
				}
				case 5:
				{
					...
					if ( pack != null && pack.ConsumeTotal( typeof( Gold ), m_Offer ) )
					{
						...
						m_From.LocalOverheadMessage( MessageType.Regular, 0xb94, true, "Le Mal est avec toi" );
						m_From.TithingPoints += m_Offer;

						m_From.PlaySound( 264 );
						//m_From.PlaySound( 0x2E6 );
					}
					else
					{
						// You do not have enough gold to tithe that amount!
						m_From.LocalOverheadMessage( MessageType.Regular, 0xb94, true, "Misere" );
					}
