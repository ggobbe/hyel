...
{
    public class AntiMatraMassSpell : DruidSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
				"AntiMatra de masse", "Vas An Nat",
				263,
				9002,
				Reagent.Garlic,
      ...
      public override int RequiredMana{ get{ return 35; } }	
		...
		public AntiMatraMassSpell( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		{
			private AntiMatraMassSpell m_Owner;

			public InternalTarget( AntiMatraMassSpell owner ) : base( 12, true, TargetFlags.None )
			{
				m_Owner = owner;
			}
