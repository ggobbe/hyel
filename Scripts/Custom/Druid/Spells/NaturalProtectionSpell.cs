...
{
    public class NaturalProtectionSpell : DruidSpell
	{
		private static Hashtable m_Registry = new Hashtable();
		public static Hashtable Registry { get { return m_Registry; } }

		private static SpellInfo m_Info = new SpellInfo(
				"Protection Naturelle", "En Crur Sanct ",
				236,
				9011,
		...
		public NaturalProtectionSpell( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		private class InternalTimer : Timer
		{
			...
			{
				NaturalProtectionSpell.Registry.Remove( m_Caster );
