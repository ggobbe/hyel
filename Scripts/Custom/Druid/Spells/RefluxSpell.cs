...
{
    public class RefluxSpell : DruidSpell
	{
      ...
      public override int RequiredMana{ get{ return 10; } }
		...
		public RefluxSpell( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		public override void OnCast()
		{
			...
			else
			{
				...
				else if ( CheckSequence() )
				{
					...
					{
						int value = (int)(Caster.Skills[SkillName.Magery].Value + Caster.Skills[SkillName.Meditation].Value + Caster.Skills[SkillName.AnimalLore].Value);
						value /= 3;
