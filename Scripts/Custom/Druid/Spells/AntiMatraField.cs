...
{
    public class AntiMatraFieldSpell : DruidSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
				"AntiMatra de champ", "An Grav Nat",
				206,
				9002,
				Reagent.BlackPearl,
				Reagent.SpidersSilk,
      ...
      public override int RequiredMana{ get{ return 30; } }	
		...
		public AntiMatraFieldSpell( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		{
			private AntiMatraFieldSpell m_Owner;

			public InternalTarget( AntiMatraFieldSpell owner ) : base( 12, false, TargetFlags.None )
			{
				m_Owner = owner;
			}
