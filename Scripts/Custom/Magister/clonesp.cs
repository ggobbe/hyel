...
{
    public class clonesp : MagisterSpell
	{
		...
		public clonesp( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
...
DeleteFromLayer(from, Layer.Mount);
		...
		{
			private clonesp m_Owner;

			public InternalTarget( clonesp owner ) : base( 12, false, TargetFlags.Harmful )
			{
				m_Owner = owner;
			}
